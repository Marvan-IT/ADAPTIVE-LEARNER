...
def _prealgebra_expert_graph() -> dict:
    ...
    return {
        ...
        f"{P}.C2.S3.SOLVING_EQUATIONS_USING_THE_SUBTRACTION_AND_ADDITION_PROPERTIES": [
            f"{P}.C2.S2.EVALUATE_SIMPLIFY_AND_TRANSLATE_EXPRESSIONS",
        ],
        ...
        f"{P}.C3.S5.SOLVE_EQUATIONS_USING_INTEGERS_THE_DIVISION_PROPERTY_OF_EQUALITY": [
            ...
            f"{P}.C2.S3.SOLVING_EQUATIONS_USING_THE_SUBTRACTION_AND_ADDITION_PROPERTIES",  # equation solving
        ],
        ...
        f"{P}.C8.S1.SOLVE_EQUATIONS_USING_THE_SUBTRACTION_AND_ADDITION_PROPERTIES_OF": [
            f"{P}.C2.S3.SOLVING_EQUATIONS_USING_THE_SUBTRACTION_AND_ADDITION_PROPERTIES",
            f"{P}.C3.S3.SUBTRACT_INTEGERS",                # equations with integer solutions
        ],
        f"{P}.C8.S2.SOLVE_EQUATIONS_USING_THE_DIVISION_AND_MULTIPLICATION_PROPERTIES": [
            f"{P}.C8.S1.SOLVE_EQUATIONS_USING_THE_SUBTRACTION_AND_ADDITION_PROPERTIES_OF",
            f"{P}.C3.S4.MULTIPLY_AND_DIVIDE_INTEGERS",
        ],
        ...
        f"{P}.C9.S3.USE_PROPERTIES_OF_ANGLES_TRIANGLES_AND_THE_PYTHAGOREAN": [
            f"{P}.C8.S2.SOLVE_EQUATIONS_USING_THE_DIVISION_AND_MULTIPLICATION_PROPERTIES",
